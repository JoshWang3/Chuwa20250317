...
- **Usage**: Used with `@Query` to indicate that the query is not a select but an update, delete, or insert.
- **Understanding**: Required for queries that modify the database.
